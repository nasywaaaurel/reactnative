...
const App = () => {
    ...
    const saveData = async () => {
        try {
            ...
            Alert.alert("Sukses", "Data berhasil tersimpan");
            setName(''); setOpenHour(''); setDescription('');
            setLocation(''); setAccuration(''); setType('wisata');
    ...
    return (
        <SafeAreaProvider style={{ flex: 1, backgroundColor: 'white' }}>
            <SafeAreaView style={{ flex: 1 }}>
                <Stack.Screen options={{ title: 'Tambahkan lokasi' }} />
                <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
                    ...
                    <View style={styles.pickerContainer}>
                        <Picker
                            ...
                            style={styles.picker}       // height cukup
                            itemStyle={{ fontSize: 14 }} // font tidak terlalu besar
                        >
...
const styles = StyleSheet.create({
    ...
    pickerContainer: {
        ...
        overflow: 'hidden',
        marginBottom: 12,
        height: 40,          // tinggi lebih kecil
        justifyContent: 'center',
        paddingHorizontal: 5, // padding supaya teks tidak menempel
    },
    pickerSmall: {
        height: 35,          // tinggi picker lebih kecil
        width: '100%',
    },
    button: {
        margin: 12,
